...
/***/ function(module, exports, __webpack_require__) {
	...
	_axios2.default.get('http://localhost:9001/v1/demo/data').then(function (response) {
	  _reactDom2.default.render(_react2.default.createElement(_greeting2.default, { resp: 'World', customers: response.data.response.customers }), document.querySelector('.greeting-component'));
	}).catch(function (response) {
	  _reactDom2.default.render(_react2.default.createElement(_greeting2.default, { resp: 'API Error', customers: '0' }), document.querySelector('.greeting-component'));
	});
	...
	var Greeting = function (_React$Component) {
	  ...
	  _createClass(Greeting, [{
	    ...
	    value: function render() {
	      var greetingClass = (0, _classnames2.default)({ 'greeting': true });
